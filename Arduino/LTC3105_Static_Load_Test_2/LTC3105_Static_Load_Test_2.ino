...
const uint8_t INA219_ADDR_1 = 0x44;         // Default address (A0=GND, A1=GND)
const uint8_t INA219_ADDR_2 = 0x45;         // Alternative address (A0=VDD, A1=GND)
