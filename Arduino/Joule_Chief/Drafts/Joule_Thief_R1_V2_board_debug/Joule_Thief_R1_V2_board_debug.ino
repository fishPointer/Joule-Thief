...
const uint8_t INA219_ADDR_C1 = 0x4E;         // Channel C Input (A0=GND, A1=VDD)
const uint8_t INA219_ADDR_C2 = 0x4F;         // Channel C Output (A0=VDD, A1=VDD)
...
AD5280 AD01_C(0x2F);  // Channel C - AD0 & AD1 == GND
