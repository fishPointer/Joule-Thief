...
const uint8_t INA219_ADDR_B1 = 0x48;         // Channel B Input (A0=GND, A1=GND)
const uint8_t INA219_ADDR_B2 = 0x49;         // Channel B Output (A0=VDD, A1=GND)
...
const int DIGITAL_OUTPUT_PIN_4 = 12; // SHDN state of charger channel1
const int DIGITAL_OUTPUT_PIN_5 = 11; // SHDN state of charger channel1
const int DIGITAL_OUTPUT_PIN_6 = 10; // SHDN state of charger channel1
...
// Hill-climbing MPPT variables for Channel A (efficiency optimization)
