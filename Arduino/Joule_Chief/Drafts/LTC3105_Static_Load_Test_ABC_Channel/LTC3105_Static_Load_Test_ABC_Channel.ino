//TRIPLE CHANNEL A, B & C MPPC CONTROLLER
...
void hillClimbMPPC_C() {
  ...
  // If we hit the voltage constraint, reverse direction for next iteration
  if (mppcValueC >= maxAllowedMPPC) {
    directionC = -1;  // Force downward direction
  }
